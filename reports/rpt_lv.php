<?php 
	...
	$pdf->SetXY(132.5,167);$pdf->Image('../signatures/'.$LivInfo['EmpID'].'.png',116,155,88,20,'PNG');
	//Employee details
	...
	if($LivInfo['LeaveTypeID']=="LT01"){
		...
		$pdf->SetXY(27,98);$pdf->Cell(5,4,'X',0,1,'L',false);
	}
	elseif($LivInfo['LeaveTypeID']=="LT02"){
		...
		$pdf->SetXY(27,103);$pdf->Cell(5,4,'X',0,1,'L',false);
	}
	...
	$pdf->SetFont('Arial','B',10);
		$pdf->SetXY(132.5,167);$pdf->Image('../signatures/'.$LivInfo['EmpID'].'.png',116,155,88,20,'PNG');
		$pdf->Cell(55,4,getEmpName($LivInfo['EmpID']),'T',0,'C',false);
